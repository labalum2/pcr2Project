...
$informationColumns = array(
	'id' => "",		//unique alphanummeric value expected from this column
	'name' => "",	//string for the name of the poi
	'description' => "", //string description
	'author' => "", //string author
	'latitude' => "", //number latitude
	'longitude' => "", //number longitude
	'mimetype' => "", //mime-type (see http://www.junaio.com/publisher/returnparameters)
	...
	'mail' => "", //email address
	'homepage' => "", //homepage
	'enablerouting' => "", //expects "true" or "false" from this column -> can the user be routed to that POI
);
