...
$informationColumns = array(
	'id' => "building_id",		//unique alphanummeric value expected from this column
	'name' => "building_name",	//string for the name of the poi
	'description' => "building_description", //string description
	'author' => "!Victor", //string author
	...
	'thumbpath' => "!http://a3.twimg.com/profile_images/857277162/Acr_nimoUC3M_normal.jpg", //url to thumbnail
	'iconpath' => "!http://userserve-ak.last.fm/serve/64/1921775.jpg", //url to icon
